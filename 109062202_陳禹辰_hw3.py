...
class Records:
    ...
    def __init__(self):
        """initialize the records from records.txt"""
        records = []
        try:                                                    #(7)
    ...
    def find(self, target_categories):
        """find the records under target categories"""
...
class Categories:
    ...
    def view(self):
        """view the categories in proper indentation"""
    ...
    def find_subcategories(self, category):
        """find the subcategories (include target category) under target category"""
